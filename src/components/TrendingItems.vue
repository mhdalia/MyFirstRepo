...
<template>    
       <!-- Trending Item Start -->
       <section class="d10ec-trend-product section-space-p">
        <div class="container">
            <div class="row">
                                ...
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/137_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/137_1.jpg"
                                            alt="Product" />
                                    </a>
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/130_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/130_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Breaker machine smart tech</a>
                                </h5>
                                <span class="ec-price">
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/128_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/128_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <div class="ec-pro-actions">
                                        <button title="Add To Cart" class=" add-to-cart"><i class="fi-rr-shopping-basket"></i></button>
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Single drilling machine vss1</a></h5>
                                <span class="ec-price">
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/129_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/129_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <div class="ec-pro-actions">
                                        <button title="Add To Cart" class=" add-to-cart"><i class="fi-rr-shopping-basket"></i></button>
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Grinder machine striker s1</a>
                                </h5>
                                <span class="ec-price">
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/131_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/131_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="flags">
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Ceramic tiles cutter</a>
                                </h5>
                                <span class="ec-price">
                                    <span class="old-price">$450</span>
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/136_1.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/136_1.jpg"
                                            alt="Product" />
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Messoring tap tools</a></h5>
                                <span class="ec-price">
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/138_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/138_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="flags">
                                        <span class="sale">Top Seller</span>
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Screwdrivers Set</a>
                                </h5>
                                <span class="ec-price">
                        ...
                        <div class="ec-product-inner">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <a href="product-left-sidebar.html" class="image">
                                        <img class="main-image"
                                            src="src/assets/images/product-image/139_2.jpg"
                                            alt="Product" />
                                        <img class="hover-image"
                                            src="src/assets/images/product-image/139_1.jpg"
                                            alt="Product" />
                                    </a>
                                    <span class="flags">
                                        <span class="stock">Out of stock</span>
                            ...
                            <div class="ec-pro-content">
                                <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Spanner hand tool vss</a>
                                </h5>
                                <span class="ec-price">
...
#ec-category-menu .ec-cat-menu-link .svg_img {
  margin-right: 10px;
}
...
.ec-brand-area .ec-brand-outer {
  padding: 0;
}
.ec-brand-area .slick-arrow.slick-next, .ec-brand-area .slick-arrow.slick-prev {
  top: 50%;
  -webkit-transform: translateY(-58%);
          transform: translateY(-58%);
}
.ec-brand-area .slick-arrow.slick-next {
  right: -5px;
}
.ec-brand-area .slick-arrow.slick-prev {
  left: -5px;
}
...
.ec_cat_content .ec-cat-desc span {
  width: 100%;
}
...
.ec-main-slider .slick-dots li button {
  display: none;
}
...
.ec-main-slider .slide-1 {
  height: 70vh;
  background-image: url("../images/main-slider-banner/26.jpg");
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
.ec-main-slider .slide-2 {
  height: 70vh;
  background-image: url("../images/main-slider-banner/27.jpg");
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
.ec-main-slider .slide-3 {
  height: 70vh;
  background-image: url("../images/main-slider-banner/28.jpg");
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
...
.ec-about-sec .ec-about-detail h4, .ec-about-sec .ec-about-detail .h4 {
  margin-bottom: 20px;
  font-size: 22px;
  font-weight: 600;
  text-transform: uppercase;
...
.ec-about-sec .ec-about-detail h5, .ec-about-sec .ec-about-detail .h5 {
  margin-bottom: 20px;
  font-size: 16px;
  font-weight: 500;
  color: #444444;
...
.ec-offer-section .ec-banner-info-10 {
  height: 500px;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  ...
  -webkit-box-pack: center;
      -ms-flex-pack: center;
          justify-content: center;
  background-image: url("../images/offer-image/offer_bg_10.jpg");
  background-size: cover;
  background-position: center;
  background-repeat: no-repeat;
}
...
.ec-test-section .ec-test-name-info {
  width: 100%;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
@media only screen and (max-width: 991px) {
  ...
  .ec-banners .ec-banner-right .ec-banner-block-2, .ec-banners .ec-banner-right .ec-banner-block-3, .ec-banners .ec-banner-right .ec-banner-block-4 {
    padding: 15px;
  }
  .section-title .ec-title {
    font-size: 18px;
  ...
  .ec-banner-left.col-md-6 {
    width: 100%;
  }
  .ec-banner-left.col-md-6 .ec-banner-block {
    padding: 15px;
  }
  .ec-category-menu .ec-category-toggle {
    min-height: 50px;
  ...
  .ec-offer-section .ec-offer-stitle {
    font-size: 18px;
  }
  .ec-offer-section .ec-banner-info-10 {
    height: 350px;
