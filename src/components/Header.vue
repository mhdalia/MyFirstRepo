                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center ec-header-logo">
                            <div class="header-logo">
                                <a href="index.html"><img src="src/assets/images/logo/logo.png" alt="Site Logo" /><img
                                        class="dark-logo" src="src/assets/images/logo/dark-logo-6.png" alt="Site Logo"
                    ...
                    <ul>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><router-link to="ShopFullWidthCol5">5 Columns full width</router-link></li>
                        ...
                        <li class="dropdown"><a href="javascript:void(0)">Blog</a>
                            <ul class="sub-menu">
                                ...
                                <li><router-link to="BlogDetailLeftSidebar">Blog detail left sidebar</router-link></li>
                                <li><router-link to="BlogDetailRightSidebar">Blog detail right sidebar</router-link></li>
                            ...
                            <div class="ec-category-content">
                                <div class="ec-category-dropdown">
                                    <ul class="ec-category-wrapper">
                                        <li><a title="Juice & Drinks" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/drink-6.png"
                                            class="svg_img search_svg" alt="" />juice & drinks</a></li>
                                        <li><a title="Fresh Fruits" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/fruit-6.png"
                                            class="svg_img search_svg" alt="" />Fresh Fruits</a></li>
                                        <li><a title="Snack & Spices" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                                <img src="src/assets/images/icons/pack-6.png"
                                                class="svg_img search_svg" alt="" />Snack & Spices</a></li>
                                        <li><a title="Vegetables" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/vege-6.png"
                                            class="svg_img search_svg" alt="" />Vegetables</a></li>
                                        <li><a title="Dairy & Milk" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/dairy-6.png"
                                            class="svg_img search_svg" alt="" />dairy & milk</a></li>
                                        <li><a title="Meat & Sea Food" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/dish-6.png"
                                            class="svg_img search_svg" alt="" />Meat & Sea Food</a></li>
                                        <li><a title="Bakery Products" class="ec-cat-menu-link" href="#shop-left-sidebar-col-3.html">
                                            <img src="src/assets/images/icons/bak-6.png"
                                            class="svg_img search_svg" alt="" />bakery products</a></li>
                                            <li class="show"><a title="" class="ec-cat-menu-link" href="shop-left-sidebar-col-3.html">Show more <img src="src/assets/images/common/arrow-dropdown.png" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="ec-main-menu">
                                        <ul>
                                            ...
                                            <li class="dropdown drop-list position-static">
                                                <a href="javascript:void(0)" class="dropdown-arrow">Categories<i class="ecicon eci-angle-right"></i></a>
                                            ...
                                            <li class="dropdown drop-list"><span class="main-label-note-new" data-toggle="tooltip"
                                                    title="NEW"></span>
                                                    <a href="javascript:void(0)" class="dropdown-arrow">Others<i class="ecicon eci-angle-right"></i></a>
                                                <ul class="sub-menu">
                                            ...
                                            <li class="dropdown drop-list">
                                                <a href="javascript:void(0)" class="dropdown-arrow">Blog<i class="ecicon eci-angle-right"></i></a>
                                                <ul class="sub-menu">
                                            ...
                                            <li class="dropdown drop-list">
                                                <a href="javascript:void(0)" class="dropdown-arrow">Elements<i class="ecicon eci-angle-right"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="elemets-products.html">Products</a></li>
                                                    <li><a href="elemets-typography.html">Typography</a></li>
                                                    <li><a href="elemets-title.html">Titles</a></li>
                ...
                <div class="row ">
                    <div class="ec-flex">
                        ...
                        <div class="col ec-header-logo">
                            <div class="header-logo">
                                <a href="index.html"><img src="src/assets/images/logo/logo-6.png" alt="Site Logo" /><img class="dark-logo" src="src/assets/images/logo/dark-logo-6.png" alt="Site Logo" style="display: none;" /></a>
                            </div>
                        </div>
                        <!-- Ec Header Logo End -->
                        <div class="col ec-category-block">
