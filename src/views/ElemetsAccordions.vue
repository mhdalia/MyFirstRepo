                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Accordions</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="ec-breadcrumb-item active">Accordions</li>
                            </ul>
    ...
    <section class="ec-page-content section-space-p">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Box Shadow</h2>
                        <h2 class="ec-title">Box Shadow</h2>
                        <p class="sub-title mb-3">Customer service management</p>
                    </div>
                </div>
    ...
    <section class="ec-page-content section-space-p">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Colors</h2>
                        <h2 class="ec-title">Colors</h2>
                        <p class="sub-title mb-3">Customer service management</p>
                    </div>
                </div>
                <div class="ec-faq-container-3">
                    <div class="ec-faq-wrapper">
                        <h2 class="ec-faq-heading">What is ekka services?</h2>
                        <div id="ec-faq-2">
                            <div class="col-sm-12 ec-faq-block">
