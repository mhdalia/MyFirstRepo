                                                ...
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="src/assets/images/product-image/1_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="src/assets/images/product-image/1_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="src/assets/images/product-image/8_1.jpg"
                                                            alt="Product" />
                                                        <img class="hover-image"
                                                            src="src/assets/images/product-image/8_2.jpg"
                                                            alt="Product" />
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="ec-sb-block-content">
                                <div class="ec-check-pay-img-inner">
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment1.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment2.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment3.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment4.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment5.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment6.png" alt="">
                                    </div>
                                    <div class="ec-check-pay-img">
                                        <img src="src/assets/images/icons/payment7.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
